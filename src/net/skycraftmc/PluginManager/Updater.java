...
public class Updater {
	...
	public static UpdateInformation findUpdate(String slug) throws FileNotFoundException, IOException, XMLStreamException {
		URL result = null;
		URL filerss = new URL("http://dev.bukkit.org/bukkit-mods/" + slug + "/files.rss");
