...
public class PMCommandExecutor implements CommandExecutor {
	...
	private final CmdDesc[]     help = { new CmdDesc("plm enable <plugin>", "Enables a plugin", "pluginmanager.enable"),
	        ...
	        new CmdDesc("plm unload <plugin>", "Unloads a plugin", "pluginmanager.unload"), new CmdDesc("plm reload <plugin>", "Unloads and loads a plugin", "pluginmanager.reload"),
