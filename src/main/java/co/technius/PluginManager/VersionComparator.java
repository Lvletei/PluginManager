...
{
    public static final VersionComparator   THREE_DIGIT = new VersionComparator(
                                                                "(?:.* )?v?([\\d]+)\\.?([\\d]+)?\\.?([\\d]+)?") {
                                                            protected int compare0(Matcher m1,
                                                                    Matcher m2)
                                                            {
                                                                ...
                                                                for (int i = 1; i < m; i++)
                                                                {
                                                                    int v1 = Integer.parseInt(m1
                                                                            .group(i));
                                                                    int v2 = Integer.parseInt(m2
                                                                            .group(i));
                                                                    if (v1 > v2)
                                                                        return 1;
                                                                    else if (v2 > v1)
