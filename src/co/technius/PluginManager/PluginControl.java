...
public class PluginControl
{
            ...
            IllegalArgumentException, IllegalAccessException, PMStartupException
    {
        ...
        try
        {
            pclClass = Class.forName("org.bukkit.plugin.java.PluginClassLoader");
        }
    ...
    public boolean closeClassLoader(Plugin plugin)
    {
        ...
        try
        {
            if (pclClass.isAssignableFrom(cl.getClass()))
            {
                Object pcl = pclClass.cast(cl);
    ...
    public boolean unloadPlugin(Plugin plugin)
    {
        ...
        try
        {
            Map<String, Object> loaderMap = (Map<String, Object>) loadersF.get(jpl);
